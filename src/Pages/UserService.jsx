    ...
    <div className="user-terms pt-20 pb-10">
      ...
      <div className="p-14 pt-6">
        <section>
          <p>
            <strong>
              THIS AGREEMENT CONTAINS A MANDATORY ARBITRATION PROVISION, WAIVER
              OF JURY TRIAL & CLASS ACTION.
            </strong>{" "}
            PLEASE REVIEW ALL PROVISIONS CONTAINED HEREIN. If you do not agree
            to these provisions, do not use this platform/site or services. By
        ...
        <section>
          <p>
            ...
            (collectively “Services”). Services through this platform/site are
            for the benefit of Third Parties only. This platform/service is
            intended for United States residents only.
          </p>
          <p>
            You understand and agree that if you provide an inquiry for
            additional information on this platform, the information you
            provided will be purchased by the client network, affiliates, and/or
            vendors in order to provide such services. Some business partners
            include companies who provide business services for us or on our
            behalf in order to deliver marketing services to you.
          </p>
          <p>
            Prior to submitting your inquiry, you will give prior expressed
            written consent to share the information you have provided in order
            to receive autodialed or prerecorded calls and texts as well as
            emails from us and/or our client network, affiliates, and vendors to
            the phone numbers (including mobile numbers) and email addresses you
          ...
          <p>
            ...
            client network that may be related to the service or product you
            have expressed interest in. As a result, different businesses may
            contact you.
          </p>
          <p>
            We do not charge you a fee to use this platform and its Services. We
            are not a lender, debt service, debt settlement, real estate
            company, insurance agent, auto sales company, automotive warranty
            organization, or home service provider. All requirements to qualify
            for financial products are made by the client network, and we do not
            endorse, warrant, or guarantee such results.
          </p>
        </section>
        ...
        <section>
          <p>
            You shall not use this platform/service for any illegal purpose or
            for the transmission of any unlawful material or material that is
            abusive, harmful, harassing, libelous, racially or ethnically
            offensive, invasive of another's privacy, obscene, threatening,
            vulgar, sexually explicit, tortious, defamatory, or that infringes
            or may infringe on the intellectual property or rights of another,
            or in a reasonable person’s view objectionable. Other prohibited
        ...
        <section>
          <p>
            ...
            THE OPERATION OF OUR SERVICES OR THE INFORMATION, CONTENT,
            MATERIALS, OR SERVICES INCLUDED ON OR ASSOCIATED WITH OUR SERVICES.
          </p>
        </section>
        ...
        <section>
          <p>
            ...
            exclusively through final and binding arbitration. You agree to
            waive your right to participate in any class action lawsuit or
        ...
        <section>
          <p>
            We may terminate or suspend this platform/service at any time for
